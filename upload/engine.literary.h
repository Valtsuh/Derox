...
#define BR	{175, 175, 25}
#define LBR {250, 195, 95}
#define BRN	{190, 50, 10}
...
#define ENGINE_MAP_Q				{0.00027, 113, -1, '*', '*',	{3, 5, R, G, B, R, G, B, R, G, B, R, G, B, R, G, B, R, G, B, R, G, B, R, G, B, R}}
...
#define ENGINE_MAP_Z				{0.00036, 122, -1, '*', '*',	{3, 5, R, G, B, R, G, B, R, G, B, R, G, B, R, G, B, R, G, B, R, G, B, R, G, B, R}}
#define ENGINE_MAP_SPACE			{0.00037, -1, -1, ' ', ' ',		{1, 5, X, X, X, X, X, X, X, X, X, X, X, X, X, X, X, R, G, B, R, G, B, R, G, B, R}}
#define ENGINE_MAP_QUESTION			{0.00038, -1, -1, '?', '?',		{3, 5, B, X, X, X, X, B, X, B, X, B, B, B, B, X, X, R, G, B, R, G, B, R, G, B, R}}
#define ENGINE_MAP_MINUS			{0.00039, -1, -1, '-', '-',		{2, 5, X, X, B, X, X, X, X, B, X, X, X, X, X, X, X, R, G, B, R, G, B, R, G, B, R}}
#define ENGINE_MAP_PLUS				{0.0004, -1, -1, '+', '+',		{3, 5, X, X, B, X, X, X, B, B, B, X, X, X, B, X, X, R, G, B, R, G, B, R, G, B, R}}
#define ENGINE_MAP_AND				{0.00041, -1, -1, '&', '&',		{4, 5, X, B, X, B, X, B, X, B, X, B, B, X, X, B, X, X, X, B, X, B, B, R, G, B, R}}	
#define ENGINE_MAP_EXCLAMATION		{0.00042, -1, -1, '!', '!',		{1, 5, B, B, B, X, B, B, X, B, X, B, B, X, X, B, X, X, X, B, X, B, B, R, G, B, R}}	
#define ENGINE_TYPOGRAPH			{ENGINE_MAP_ZERO, ENGINE_MAP_ONE, ENGINE_MAP_TWO, ENGINE_MAP_THREE, ENGINE_MAP_FOUR, ENGINE_MAP_FIVE, ENGINE_MAP_SIX, ENGINE_MAP_SEVEN, ENGINE_MAP_EIGHT, ENGINE_MAP_NINE, ENGINE_MAP_A, ENGINE_MAP_B, ENGINE_MAP_C, ENGINE_MAP_D, ENGINE_MAP_E, ENGINE_MAP_F, ENGINE_MAP_G, ENGINE_MAP_H, ENGINE_MAP_I, ENGINE_MAP_J, ENGINE_MAP_K, ENGINE_MAP_L, ENGINE_MAP_M, ENGINE_MAP_N, ENGINE_MAP_O, ENGINE_MAP_P, ENGINE_MAP_Q, ENGINE_MAP_R, ENGINE_MAP_S, ENGINE_MAP_T, ENGINE_MAP_U, ENGINE_MAP_V, ENGINE_MAP_W, ENGINE_MAP_X, ENGINE_MAP_Y, ENGINE_MAP_Z, ENGINE_MAP_SPACE, ENGINE_MAP_QUESTION, ENGINE_MAP_MINUS, ENGINE_MAP_PLUS, ENGINE_MAP_AND, ENGINE_MAP_EXCLAMATION}
