...
#define ENGINE_MAP_S				{0.00029, 115, -1, 's', 'S',	{{GR, B, GR, X, B, B, X, B, X, B, B, X, GR, B, GR, R, G, B, R, G, B, R, G, B, R}, 3}}
...
#define ENGINE_MAP_COLON			{0.00047, -1, -1, ':', ':',		{{X, B, X, B, X}, 1}}
#define ENGINE_MAP_COMMA			{0.00048, -1, -1, ',', ',',		{{X, X, X, X, B, X, X, X, B, X}, 2}}
